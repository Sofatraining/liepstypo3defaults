...
***
#### v1.0.9  
Add lib.dynamicContentSlide + Add option container-fluid to section template + Add BgImage to section template + Fix Error Page-Template None.html + Finetuning
